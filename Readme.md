This is a simple flask project made to explore how to host/show images which are generated using a lot of userdriven data without the need of encoding the data into an image URL.
